...
export function Hero() {
  ...
  return (
    <section className="font-body mx-auto flex flex-col justify-center pt-4 sm:px-6 sm:py-12 lg:flex-row lg:justify-between lg:py-24">
      <div className="flex flex-col justify-center rounded-sm text-center sm:p-6 lg:max-w-md lg:text-left xl:max-w-lg">
        ...
        <div className="flex flex-col space-y-4 sm:flex-row sm:items-center sm:justify-center sm:space-y-0 sm:space-x-4 lg:justify-start">
          <Button variant="link" className="text-accent px-8 py-3 text-lg font-semibold">
            <a href="https://github.com/wvovaw/the-button" target="_blank" rel="noreferrer noopener">
              Source Code
            </a>
          </Button>
          {isAuthenticated() ? (
      ...
      <div className="mt-8 flex h-72 items-center justify-center sm:h-80 sm:p-6 lg:mt-0 lg:h-96 xl:h-112 2xl:h-128">
        <Stats />
      </div>
    </section>
  )
